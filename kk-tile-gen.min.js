                            ...
                            <% for (var i = 0; i < basketItems.length; i++){ %>
                                ...
                                <%if (item.product != null) { %>
                                    <div class="kkpct-shopping-cart-item">
                                    	<a href=\ '#\' class="kkpct-cart-item-image" id=\ '<%="kkpct-"+item.product.id%>\'>
                                    		<img src="<%=item.prodImage%>" border="0" alt="<%=item.product.name%>" title=" <%=item.product.name%> ">
                                    	</a>
        ...
        <div class="kkpt-single">
            ...
            <div class="item item-uxme">
                <div class="carouselContenedor">
                    <img src="<%=prodImage%>" alt="" class="img-responsive">
...
kkMsgMap.en_GB = {
    ...
    "cart.tile.empty": "El carrito est&aacute; vac&iacute;o",
    "cart.tile.quantity": "Quantity",
    "cart.tile.shoppingcart": "Carrito",
    "cart.tile.subtotal": "Subtotal",
    "cart.tile.checkout": "Checkout",
    "edit.cart.tile.emptycart": "El carrito est&aacute; vac&iacute;o",
    ...
    "customer.info.prod.notify.prodnots": "Notificaciones de Productos",
    ...
    "wishlist.tile.wishlist": "Lista de deseos",
